...
namespace Warehouse.Server.Migrations
{
    ...
    [Migration("20250808183359_NoNullableValues")]
    partial class NoNullableValues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Warehouse.Server.Models.MeasureUnit", b =>
                {
                    ...
                    b.Navigation("ReceiveResources");

                    b.Navigation("SendResources");
                });
